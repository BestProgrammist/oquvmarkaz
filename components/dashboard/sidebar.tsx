...
const studentNavItems = [
  ...
  { href: '/dashboard/schedule', label: 'Dars Jadvali', icon: Calendar },
  { href: '/dashboard/courses', label: 'Mening Kurslarim', icon: BookOpen },
  { href: '/dashboard/materials', label: 'O\'quv Materiallari', icon: FileText },
  { href: '/dashboard/chat', label: 'Chat', icon: MessageSquare },
  { href: '/dashboard/grades', label: 'Baholar', icon: BarChart },
  { href: '/dashboard/progress', label: 'Progress', icon: Award },
  { href: '/dashboard/attendance', label: 'Davomat', icon: Clock },
]
...
export function DashboardSidebar() {
  ...
  const userRole: 'student' | 'teacher' = 'teacher' // Bu keyin backenddan keladi
  const navItems = userRole === 'teacher' ? studentNavItems : teacherNavItems
    ...
    <div className="flex h-full flex-col border-r bg-white dark:bg-gray-900">
      ...
      <div className="p-6 border-b">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold">Azizov Sardor</div>
            <div className="text-sm text-gray-500 dark:text-gray-400">9B Matematika</div>
          </div>
        </div>
